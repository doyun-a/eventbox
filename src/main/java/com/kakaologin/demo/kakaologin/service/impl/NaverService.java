...
import com.kakaologin.demo.kakaologin.dto.NaverDTO;
import com.kakaologin.demo.kakaologin.util.JwtUtil;
...
public class NaverService {
    ...
    public String createJwtForUser(NaverDTO userInfo) {
        // JWT Payload에 포함할 사용자 정보 설정
        Map<String, Object> claims = new HashMap<>();
        claims.put("id", userInfo.getId());
        claims.put("nickname", userInfo.getName());
